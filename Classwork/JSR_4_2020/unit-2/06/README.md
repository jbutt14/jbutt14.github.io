...
## Last Class
Last class, we worked on creating and returning values from functions, global and local scopes! Any questions?
...
An object is an associative array, also known as a hash or a dictionary in other languages. It stores key-value pairs, and unlike arrays, is not ordered. Object properties are letiables attached to a specific object.
...
### Example
[objects](https://editor.p5js.org/kyle1james/embed/qpvk_NhxG)
...
With a parter or small group, consider one or two of the following scenarios.  Identify likely objects, attributes, and methods in each scenario.  Remember to consider implicit objects as well as explicit ones. You will be coding out these objects after planning.
...
> More info on prototype
> - [MDN](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Inheritance_and_the_prototype_chain)
> - [Interview Questions](https://medium.com/javascript-scene/master-the-javascript-interview-what-s-the-difference-between-class-prototypal-inheritance-e4cd0a7562e9)
> - [In practice](https://javascript.info/prototype-inheritance)
...
Open the [monkey.js file](starter-code/monkey.js) in the starter code OR create your very own!
...
If you want to take a look into the future, we will be using API's to get JSON data back. Check out [NASA Open APIs](https://api.nasa.gov/) documentation and look at the JSON data each request sends back! 
